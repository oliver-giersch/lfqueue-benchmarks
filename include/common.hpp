...
display_str(queue_type_t queue)
{
	switch (queue) {
	case queue_type_t::LCR:
		return "LCR";
	case queue_type_t::LOO:
		return "LOO";
	case queue_type_t::FAA:
		return "FAA";
	case queue_type_t::FAA_V1:
		return "FAA (variant 1)";
	case queue_type_t::FAA_V2:
		return "FAA (variant 2)";
	case queue_type_t::FAA_V3:
		return "FAA (variant 3)";
	case queue_type_t::MSC:
		return "MSC";
	case queue_type_t::SCQ2:
		return "LSCQ2";
	case queue_type_t::SCQD:
		return "LSCQD";
	case queue_type_t::YMC:
		return "YMC";
	default:
		return "unknown";
	}
