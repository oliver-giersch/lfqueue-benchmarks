...
namespace memory
{
  ...
  hazard_pointers<T>::hazard_pointers(
      ...
      std::size_t scan_threshold) : m_num_hazard_pointers{num_hazard_pointers},
  ...
  template <typename T>
  hazard_pointers<T>::pointer hazard_pointers<T>::protect(
  ...
  template <typename T>
  hazard_pointers<T>::pointer hazard_pointers<T>::protect_ptr(
